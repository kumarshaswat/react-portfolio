          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 max-w-[60vw] mx-auto">
              <BlurFade delay={10 * 0.1}>
                <ProjectCard
                  ...
                  description="This is my case study on how I acted as PM for the design and devlopment of the new UX webite. I assisted in creating the UI/UX and I worked with a team to devlop the website and bring it to life."
              ...
              <BlurFade delay={12 * 0.1}>
                <ProjectCard
                  title="Bankwise"
                  href="https://example.com/project"
                  description="This is a case study on how I devloped a full project in less than 24 hours. Bankwise is a banking portfolio, enabling users to manage their finances across multiple banking accounts from different banks in one place. "
                  dates="November 2022"
                  tags={['JavaScript', 'React', 'Next.js']}
                  link="https://example.com/project"
